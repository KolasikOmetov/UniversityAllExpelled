...
namespace  UniversityDatabaseImplement
{
    class UniversityDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog= UniversityAllExpelledWorkerViewDatabaseV3;Integrated Security=True;MultipleActiveResultSets=True;");
            }
